            ...
            <div>
              <div className="flex justify-between items-baseline px-4 py-6">
                ...
                <Link to={`/`} className="cursor-pointer ">
                  <p className="cursor-pointer text-center py-2 pb-5 underline text-black underline-offset-2 font-medium text-[15px] tracking-wider hidden md:block">
                    CONTINUE SHOPPING
                  </p>
                </Link>
              </div>
              ...
              <div className=" xs:text-center sm:text-center md:text-right px-4 py-6">
                ...
                <button
                  ...
                  className=" w-[300px] w-96 border-black border-l border-r border-t border-b  px-2 py-[10px] text-white
                   bg-black mb-2 text-center font-bold text-[16px] cursor-pointer "
                >
                  CHECKOUT
                </button>
